class EnumTypeMortInfo {
    ...
    static typeMortInfo() {
        return [
            ...
            new EnumTypeMortInfo(EnumTypeMort.TENUE_NORMAL, "TENUE_NORMAL", "Vous n'avez pas la bonne tenue."),
            new EnumTypeMortInfo(EnumTypeMort.TENUE_MER, "TENUE_MER", "Vous n'avez pas la bonne tenue."),
            new EnumTypeMortInfo(EnumTypeMort.TENUE_TERRE, "TENUE_TERRE", "Vous n'avez pas la bonne tenue."),
            new EnumTypeMortInfo(EnumTypeMort.TENUE_CIEL, "TENUE_CIEL", "Vous n'avez pas la bonne tenue."),
            new EnumTypeMortInfo(EnumTypeMort.TENUE_ESPACE, "TENUE_ESPACE", "Vous n'avez pas la bonne tenue."),
        ];
    }
