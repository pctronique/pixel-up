class Collision {
    ...
    testCollisionGD(persoAreteRectangle, ptfAreteRectangle, test = false) {//private
        if((persoAreteRectangle.gauche().pos > ptfAreteRectangle.droite().pos -1 &&
        persoAreteRectangle.gauche().pos < ptfAreteRectangle.droite().pos +1)
         || (persoAreteRectangle.droite().pos > ptfAreteRectangle.gauche().pos -1 &&
         persoAreteRectangle.droite().pos < ptfAreteRectangle.gauche().pos +1)) {
            if(
    ...
    getEnumCollisionGD() {
        ...
        let testCollision = this.testCollisionGD(this.personnage.getAreteRectangle(), this.plateforme.getAreteRectangle(), this.plateforme.test());
        if(testCollision == EnumCollision.NULL) {
            testCollision = this.testCollisionGD(this.personnage.getAreteRectangle(), this.plateforme.getAreteRectangleLeft());
        }
        if(testCollision == EnumCollision.NULL) {
            testCollision = this.testCollisionGD(this.personnage.getAreteRectangle(), this.plateforme.getAreteRectangleRight());
        }
        if(testCollision == EnumCollision.NULL) {
            testCollision = this.testCollisionGD(this.personnage.getAreteRectangleLeft(), this.plateforme.getAreteRectangle());
        }
        if(testCollision == EnumCollision.NULL) {
            testCollision = this.testCollisionGD(this.personnage.getAreteRectangleLeft(), this.plateforme.getAreteRectangleLeft());
        }
        if(testCollision == EnumCollision.NULL) {
            testCollision = this.testCollisionGD(this.personnage.getAreteRectangleLeft(), this.plateforme.getAreteRectangleRight());
        }
        if(testCollision == EnumCollision.NULL) {
            testCollision = this.testCollisionGD(this.personnage.getAreteRectangleRight(), this.plateforme.getAreteRectangle());
        }
        if(testCollision == EnumCollision.NULL) {
            testCollision = this.testCollisionGD(this.personnage.getAreteRectangleRight(), this.plateforme.getAreteRectangleLeft());
        }
        if(testCollision == EnumCollision.NULL) {
            testCollision = this.testCollisionGD(this.personnage.getAreteRectangleRight(), this.plateforme.getAreteRectangleRight());
        }
